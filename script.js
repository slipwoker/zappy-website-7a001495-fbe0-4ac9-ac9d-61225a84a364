    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('input', function(e) {
            if (e.target.matches('input, textarea, select')) {
                const existingError = e.target.parentElement.querySelector('.form-error');
                if (existingError) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '7a001495-fbe0-4ac9-ac9d-61225a84a364',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7a001495-fbe0-4ac9-ac9d-61225a84a364';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7a001495-fbe0-4ac9-ac9d-61225a84a364';
